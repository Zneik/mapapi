...
import static ru.zneik.mapapi.util.TestUtil.readFromJsonMvcResult;
import static ru.zneik.mapapi.util.TestUtil.readListFromJsonMvcResult;
...
public class TestMatcher<T> {
    ...
    public static <T> TestMatcher<T> usingAssertions(Class<T> clazz,
